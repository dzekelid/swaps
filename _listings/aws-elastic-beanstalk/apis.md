...
created: "2018-08-28"
modified: "2018-08-28"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/swaps/master/_listings/aws-elastic-beanstalk/apis.md
...
- name: AWS Elastic Beanstalk API - Swap Environment C N A M Es
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/swaps/master/_listings/aws-elastic-beanstalk/actionswapenvironmentcnames-get-openapi.md
- name: AWS Elastic Beanstalk API - Swap Environment C N A M Es
  x-api-slug: actionswapenvironmentcnames-get
  description: Swaps the CNAMEs of two environments.
  image: http://kinlane-productions.s3.amazonaws.com/api-evangelist-site/company/logos/Compute_AWSElasticBeanstalk.png
